...
const GRAFANA_LOGICMONITOR_OWNER = 'pavi6691';
const GRAFANA_LOGICMONITOR_REPO = 'grafana-logicmonitor';

const github = new GithubClient(GRAFANA_LOGICMONITOR_OWNER, GRAFANA_LOGICMONITOR_REPO, true);
...
async function main() {
  ...
  const releaseNotes = `# Grafana-Logicmonitor ${releaseVersion}`;
